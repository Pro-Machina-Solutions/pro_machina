...
Tote = CustomUnit(name="Tote", dimension=BaseUnit)
Case = CustomUnit(name="Case", dimension=BaseUnit)
Box = CustomUnit(name="Box", dimension=BaseUnit)
WIP_Pallet = CustomUnit(name="WIP Pallet", dimension=BaseUnit)
Finished_Pallet = CustomUnit("Finished Pallet", dimension=BaseUnit)
...
# prod_1 -> Roll -> Case -> Box -> Pallet


class UnitStack:
    def __init__(self, translaions):
        self.translations = []

    def add_translation(self, from_unit, to_unit):
        pass
